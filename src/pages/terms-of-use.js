  ...
  return (
    <div className='body terms_of_use'>
      ...
      <p>
        ...
        including the features, availability, or operation of the site, these
        Terms of Use, or any policy or notice posted on the site. You agree that
        it is your responsibility to monitor changes to the site, and your
        continued use of this site following the posting of changes means that
        you agree to and accept the changes.
      </p>
      <h3>Ability to Accept Terms of Use</h3>
      <p>
        You affirm that you are over the age of legal majority, can form legally
        binding agreements under applicable law, and are fully able and
        ...
        of Use, and to qualify under, abide by, and comply with these Terms of
        Use.
      </p>
      <h3>Accuracy, Completeness and Timeliness of Information</h3>
      <p>
        All of the information presented on this site is for informational
        purposes only. The information and features on this site do not
        constitute binding offers to buy or sell products or services described
        on the site, or to make such products or services available in your
        area. Likewise, none of the information presented on this site regarding
        job openings constitutes a binding offer to employ you or individuals
      ...
      <p>
        All content included on this site, such as text, design, graphics,
      ...
      <p>
        ...
        purposes, including marketing. You may not use any hardware or software
        intended to damage or interfere with the proper working of the site or
      ...
      <p>
        There may be restrictions or prohibitions applicable in certain
        jurisdictions on the purchase, resale or distribution of our goods or
        services. It is not our policy to check the laws of the jurisdictions in
        which our customers are based and accept no responsibility for any
        losses or liabilities suffered by our customers (or their customers) in
        respect of their purchase, receipt or use of our goods and services. You
        are advised to check the applicable laws in your jurisdiction.
      </p>
      <p>
        You acknowledge that you are responsible for any material you may submit
        via the site, including the legality, reliability, appropriateness,
        originality and copyright of any such material. You may not upload to,
        distribute or otherwise publish through this site any content that (i)
        is false, fraudulent, libelous, defamatory, obscene, threatening,
        invasive of privacy or publicity rights, infringing on intellectual
        property rights, abusive, illegal or otherwise objectionable, (ii) may
      ...
      <h3>Links</h3>
      <p>
        This site may contain links to other websites. These links are provided
        as a convenience to you and as an additional avenue of access to the
        information contained therein. We have not necessarily reviewed all the
        information on those other sites and are not responsible for the content
        of those or any other sites or any products or services that may be
        offered through those or any other sites. Inclusion of links to other
        sites should not be viewed as an endorsement of the content of linked
      ...
      <p>
        You may not include a link to our Web Site or display the contents of
        our Web Site surrounded or framed or otherwise surrounded by material
        not originating from us without our consent.
      </p>
      <h3>Trademarks</h3>
      <p>
      ...
      <p>
        ...
        DOWNLOAD ANY MATERIALS FROM THIS SITE, YOU DO SO AT YOUR OWN DISCRETION
      ...
      <p>
        YOU ACKNOWLEDGE THAT ANY INFORMATION YOU SEND OR RECEIVE DURING YOUR USE
        OF THE SITE MAY NOT BE SECURE AND MAY BE INTERCEPTED BY UNAUTHORIZED
        PARTIES. YOU UNDERSTAND AND ACKNOWLEDGE THAT YOU ASSUME FULL
        ...
        DELETION, DEFECT, DELAY IN OPERATION OR TRANSMISSION, COMPUTER VIRUSES,
        FILE CORRUPTION, COMMUNICATION-LINE FAILURE, NETWORK OR SYSTEM OUTAGE,
        YOUR LOSS OF PROFITS, OR THEFT, DESTRUCTION, UNAUTHORIZED ACCESS TO,
        ALTERATION OF, LOSS OR USE OF ANY RECORD OR DATA, AND ANY OTHER TANGIBLE
        OR INTANGIBLE LOSS. YOU SPECIFICALLY ACKNOWLEDGE AND AGREE THAT PEXCO,
      ...
      <p>
        ...
        resulting from your use of the site and any violation of these Terms of
        Use. If you cause a technical disruption of the site or the systems
      ...
      <p>
        ...
        <b>Mexico</b>, you do so at your own risk and with the understanding
        that laws applicable in your location may not be applicable to this
        site. By using the site, you irrevocably consent to the exclusive
        jurisdiction and venue of the courts, tribunals, agencies and other
        dispute resolution organizations in <b>Mexicali</b>,{" "}
        <b>Baja California</b>, <b>Mexico</b> for any action to enforce these
        Terms of Use or any action arising out of, relating to, or concerning
        this Site.
      </p>
      <h3>Entire Agreement</h3>
      <p>
        This agreement and any posted policies or operating rules constitute the
        entire agreement of the parties with respect to the subject matter
        hereof, and supersede all prior or contemporaneous communications and
        proposals, whether oral or written, between the parties with respect to
        such subject matter.
      </p>
      <h3>Severability</h3>
      <p>
        If any provision of this agreement is unlawful, void or unenforceable,
        the remaining provisions of the agreement will remain in place.
      </p>
